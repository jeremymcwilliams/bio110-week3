...
Below, create variables for the mean, ci, and the upper and lower limits of the confidence interval (hint: call the upper limit ymax and define it as the mean+ci, call the lower limit ymin and define it as the mean-ci)
